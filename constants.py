...
BYU_question_string = ['Please read the entire text above before selecting an answer below.',
                       ...
                       ' TAs', ' professors', ' etc) because of their gender?',
                       'Has a member of the CS department (students', ' TAs', ' professors',
                       ' etc) you ever been told that you earned a good grade', ' got a job', ' internship',
                       ...
                       ' TAs', ' professors', ' etc)?', 'If members of the CS department (students', ' TAs',
                       ' professors', ' etc) make negative comments about your appearance',
                       ' what do they comment about? (select all that apply)',
                       'Do you know how to file complaints for being treated differently because of your gender in the CS department?',
                       'Do you know what happens if a complaint is filed against a member of the CS department who is accused of being sexist?',
                       'Would you personally be worried about retribution if you filed a complaint about someone treating you or a peer differently because of your/their gender?',
                       'If you saw a peer treat someone differently because of their gender (through words', ' actions',
                       ' etc)', ' would you say or do something? (select all that apply)',
                       'When you tell people what your major is',
                       " how often do they express surprise (You don't look/act like a ____ major",
