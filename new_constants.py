...
ques_num = ['StartDate', 'EndDate', 'Status', 'IPAddress', 'Progress', 'Duration (in seconds)', 'Finished',
            'RecordedDate', 'ResponseId', 'RecipientLastName', 'RecipientFirstName', 'RecipientEmail',
            'ExternalReference', 'LocationLatitude', 'LocationLongitude', 'DistributionChannel', 'UserLanguage', 'Q70',
            'Q89', 'Q89_1_TEXT', 'Q3', 'Q3_3_TEXT', 'Q81', 'Q80', 'Q4', 'Q5', 'Q6', 'Q7', 'Q73', 'Q74', 'Q74_2_TEXT',
...
ques_num_to_shorthand = {'StartDate': 'CONSENT_CURRENT', 'EndDate': 'CONSENT_FUTURE', 'Status': 'EMAIL',
                         'IPAddress': 'GENDER', 'Progress': 'GENDER_OTHER', 'Duration (in seconds)': 'RACE',
                         'Finished': 'AGE', 'RecordedDate': 'UNIVERSITY_PROGRAM', 'ResponseId': 'UNIVERSITY_MAJOR',
                         'RecipientLastName': 'UNIVERSITY_MINOR', 'RecipientFirstName': 'UNIVERSITY_COURSES_FALL',
                         'RecipientEmail': 'UNIVERSITY_GRADUATION_YEAR', 'ExternalReference': 'UNIVERSITY_GPA',
                         'LocationLatitude': 'UNIVERSITY_GPA_TEXT', 'LocationLongitude': 'RECEIVED_INTERNSHIP_OFFER',
                         'DistributionChannel': 'EXTRACURRICULARS', 'UserLanguage': 'MAJOR_PROS',
                         'Q70': 'MAJOR_PROS_TEXT', 'Q89': 'MAJOR_CONS', 'Q89_1_TEXT': 'MAJOR_CONS_TEXT',
                         'Q3': 'CONFIDENCE_GRADUATE_GPA', 'Q3_3_TEXT': 'CONFIDENCE_PREPARED_COURSES',
                         'Q81': 'CONFIDENCE_PERCENTILE', 'Q80': 'PARTICIPATION_QUESTIONS_COMFORTABLE_NONCS',
                         'Q4': 'PARTICIPATION_ABSENT_FREQUENCY', 'Q5': 'PARTICIPATION_QUESTIONS_ASK_FREQUENCY',
                         'Q6': 'PARTICIPATION_QUESTIONS_COMFORTABLE', 'Q7': 'PARTICIPATION_NOT_QUESTIONS_FREQUENCY',
                         'Q73': 'PARTICIPATION_ABSENT_WHY', 'Q74': 'PARTICIPATION_MORE_COMFORTABLE',
                         'Q74_2_TEXT': 'PARTICIPATION_LESS_COMFORTABLE', 'Q50': 'PARTICIPATION_NOT_REASONS',
                         'Q8': 'PARTICIPATION_QUESTIONS_ASK_IGNORED', 'Q10': 'PARTICIPATION_GROUP_PROJECT_ROLE',
                         'Q10_21_TEXT': 'PROFESSORS_ASK_ADVICE', 'Q11': 'PROFESSORS_ENCOURAGED_YOU',
                         'Q11_14_TEXT': 'PARTICIPATION_TA_SESSION', 'Q68': 'PARTICIPATION_TA_ASK_QUESTIONS',
                         'Q88': 'PARTICIPATION_TALK_PEERS', 'Q93': 'COURSES_PROFESSORS_ENGAGING',
                         'Q86': 'PROFESSORS_REPRESENT_DIVERSITY', 'Q84': 'ROLE_MODELS_SAME_GENDER',
                         'Q16': 'PARTICIPATION_PEERS_HELP_YOU', 'Q15': 'PARTICIPATION_PEERS_YOU_SERVE',
                         'Q90': 'PARTICIPATION_CLUBS', 'Q83': 'PARTICIPATION_FRIENDS_CS_STUDENTS',
                         'Q91': 'FRIENDS_CS_STUDENTS_WANT_MORE', 'Q85': 'SCHOLARSHIP',
                         'Q92': 'EXTRACURRICULAR_PLANS_BEFORE_GRADUATION', 'Q57': 'FREQUENCY_BALANCE_CAREER_PARENTHOOD',
                         'Q46': 'PROFESSORS_DECLARE_PARENT', 'Q18': 'PROFESSORS_DECLARE_FULL_TIME',
                         'Q19': 'DEPARTMENT_SEXIST_YOU', 'Q21': 'DEPARTMENT_SEXIST_OTHERS',
                         'Q22': 'DEPARTMENT_SUCCESS_BECAUSE_GENDER', 'Q52': 'DEPARTMENT_APPEARANCE',
                         'Q20': 'DEPARTMENT_APPEARANCE_COMMENTS', 'Q59': 'COMPLAINTS_HOW',
                         'Q63': 'COMPLAINTS_CONCEQUENCES', 'Q26': 'COMPLAINTS_CONCEQUENCES_FEAR',
                         'Q25': 'PEER_MISTREATED_REACT', 'Q27': 'PEOPLE_SURPRISE_MAJOR',
                         'Q28': 'PEOPLE_SEXIST_JOKES_GENDER', 'Q82': 'HIGHEST_STANDARD',
                         'Q48': 'PEER_SEXISM_IGNORING_SUGGESTION', 'Q9': 'FRIENDS_OTHER_GENDER',
                         'Q32': 'INTELLIGENCE_FIXED', 'Q31': 'INTELLIGENCE_MALLEABLE', 'Q30': 'FAILURE_LAZY',
                         'Q41': 'FAILURE_ENVIRONMENT', 'Q42': 'FAILURE_ABILITY', 'Q35': 'DESCRIBE_POSITIVE_EXPERIENCE',
                         'Q62': 'DESCRIBE_NEGATIVE_EXPERIENCE', 'Q61': 'SUGGESTION_IMPROVE_INSTITUTION'}
