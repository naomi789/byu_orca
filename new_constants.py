...
NUMBER_ANSWERS = [GPA, CONFIDENCE_PERCENTILE_PEERS]
# MANY_CHOICES_QUESTIONS = [FALL_COURSES, EXTRACURRICULARS, MAJOR_PROS, MAJOR_CONS]
TEMP_MANY_CHOICES = [MAJOR_PROS, MAJOR_CONS, CONFIDENCE_GRAD_GPA, CONFIDENCE_PREPARED_COURSES]
